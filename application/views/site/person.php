...
<div class="person-data row">
    <div class="col-12 col-md-3 mb-3">
        <h2 class="mt-0 d-md-none"><?php echo $person['name'] ?></h2>
        <img src="<?php echo $person['profile_path'] ?>" class="align-self-start mr-4">
    </div>
    <div class="col-12 col-md-9">
        <h2 class="mt-0 d-none d-md-block"><?php echo $person['name'] ?></h2>
