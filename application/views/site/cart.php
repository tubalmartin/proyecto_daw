        ...
        <?php else: ?>
                ...
                <div class="row border-top py-2">
                    ...
                    <div class="col-9">
                        ...
                        <div class="d-flex flex-column flex-sm-row">
                            <form action="<?php echo site_url('/site/updatecart') ?>" method="POST" class="form-inline mb-1 mr-2">
                                <input type="hidden" name="rowid" value="<?php echo $item['rowid'] ?>">
                                <label class="mr-2">Cantidad:</label>
                                <select name="qty" class="custom-select mr-sm-2 mb-sm-0 mb-2">
                                    <?php for($i = 1; $i <= 10; $i++): ?>
                                        <option value="<?php echo $i ?>" <?php if($item['qty'] == $i): ?>selected<?php endif; ?>><?php echo $i ?></option>
                                    <?php endfor; ?>
                                </select>
                                <button type="submit" class="btn btn-warning btn-sm"><i class="fas fa-sync-alt"></i> Actualizar</button>
                            </form>
            ...
            <div class="row border-top py-2">
                <div class="col-9 offset-3">
                    ...
                    <p>
                        <a class="btn btn-warning btn-lg" href="<?php echo site_url('/site/checkout') ?>"><i class="fas fa-credit-card"></i> Pasar por caja</a> o <a class="btn btn-light btn-sm" href="<?php echo site_url('/site/store'); ?>">Seguir comprando</a>
                    </p>
                </div>
            </div>
        <?php endif; ?>
